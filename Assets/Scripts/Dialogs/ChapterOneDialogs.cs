public static class ChapterOneDialogs {
    ...
    public static Message[] Start = new Message[] 
    {
        ...
        new Message(CharacterNames.Anne7yo, "What do you remember last?"),
        ...
        new Message(CharacterNames.Anne7yo, "Oh no... How can I help you?"),
        new Message(CharacterNames.Emma, "There's a puzzle here. I think solving it might set me free."),
        new Message(CharacterNames.Anne7yo, "Don't worry, I’ll help you solve it."),
