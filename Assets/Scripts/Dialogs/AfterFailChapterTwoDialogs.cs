public static class AfterFailChapterTwoDialogs
{
    ...
    public static Message[] Start = new Message[]
    {
        ...
        new Message(CharacterNames.RobAngry, "What did you do, Anne?! You ruined everything!"),
        new Message(CharacterNames.Anne14yo, "I'm sorry, Rob. I didn't mean to..."),
        new Message(CharacterNames.RobAngry, "Sorry won't fix this! You have no idea how much this means to me!"),
        new Message(CharacterNames.Anne14yo, "I really tried, Rob. Please, give me another chance."),
        new Message(CharacterNames.RobAngry, "Another chance? You don't deserve another chance!"),
        new Message(CharacterNames.RobAngry, "You've made everything worse!"),
