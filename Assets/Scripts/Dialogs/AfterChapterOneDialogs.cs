public static class AfterChapterOneDialogs
{
    ...
    public static Message[] Start = new Message[]
    {
        ...
        new Message(CharacterNames.Anne7yo, "No, it looks like they really wanted to find you."),
        new Message(CharacterNames.Emma, "Oh... Now I can go with my family. Thank you."),
        new Message(CharacterNames.Anne7yo, "You're welcome, Emma. I hope you find peace now."),
        new Message(CharacterNames.Emma, "I will. Goodbye, Anne."),
        new Message(CharacterNames.Anne7yo, "Goodbye, Emma."),
